    ...
    <article className="welcome-section" >
      <section className="section-2-info flex-container flex-column txt-center pop-font">
        ...
        <h2 className="txt-white">
          Welcome to <span>SYEDI HOSPITALITY</span> and Travels
        </h2>
        <p>
        Explore The World with our team of professional Travel Experts for better Traveling Experience, Build your Next Holiday/visit's/ visa's Trip with Us
        </p>
      </section>
      <LazyLoadImage
